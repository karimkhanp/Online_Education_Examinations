<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Ttoefl.aspx.cs" Inherits="Default3" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <script type="text/javascript" src="../CountDown.js" ></script>
    ...
    function WindowLoad(event)
     {
    ActivateCountDown("CountDownPanel", 15);
    }
</script>
