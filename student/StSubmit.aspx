<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StSubmit.aspx.cs" Inherits="Default2" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 100%">
       ...
       <tr>
        ...
        <tr>
            <td align="right" style="height: 23px" width="50%">
                &nbsp;<asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="<< Previous" />&nbsp;&nbsp; </td>
            <td align="left" style="height: 23px" width="50%" >
                &nbsp;<asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="Next >>" /></td>
        </tr>
