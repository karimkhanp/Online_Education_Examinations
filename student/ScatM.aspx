<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ScatM.aspx.cs" Inherits="student_Default" Title="Untitled Page" %>
...
<asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [fn] FROM [material] where cat='CAT' and subcat='Material'"></asp:SqlDataSource>
