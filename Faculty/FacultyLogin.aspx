<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FacultyLogin.aspx.cs" Inherits="Default3" %>
       ...
       <tr>
            ...
            <tr>
                <td align="center" colspan="2" 
                    ...
                    <asp:HyperLink ID="HyperLink2" NavigateUrl="~/Faculty/ForgotPassF.aspx" runat="server">Forgot Password?</asp:HyperLink> 
                    <asp:Button ID="Button1" runat="server" Text="Sign In" OnClick="Button1_Click" /></td>
            </tr>
            <tr>
                <td colspan=2 align=center>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="./FormFaculty.aspx">create new account</asp:HyperLink>    
