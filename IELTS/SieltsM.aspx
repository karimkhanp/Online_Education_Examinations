<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SieltsM.aspx.cs" Inherits="student_Default3" Title="Untitled Page" %>
...
<asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [fn] FROM [material] where cat='IELTS' and subcat='Material'"></asp:SqlDataSource>
