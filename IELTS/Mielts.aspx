<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Mielts.aspx.cs" Inherits="Faculty_Default" Title="Untitled Page" EnableEventValidation="false" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [material] where cat='IELTS' and subcat='Material'"></asp:SqlDataSource>
