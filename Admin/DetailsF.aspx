<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DetailsF.aspx.cs" Inherits="Admin_Default" Title="Untitled Page" %>
...
<div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="qual" HeaderText="Qualification" ReadOnly="True" 
                    SortExpression="qual" />
...
&nbsp;&nbsp;
        ...
        <asp:Button ID="Button2" runat="server" 
            Text="Delete selected Users' accounnts" onclick="Button2_Click" />
    </fieldset>
    </center> 
    </div>
